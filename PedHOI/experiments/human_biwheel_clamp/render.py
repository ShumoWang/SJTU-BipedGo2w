...
with io.get_writer(P/'box_reference.mp4',fps=30,macro_block_size=1) as writer:
 for k in range(0,len(z['qpos']),8):
  ...
  draw.text((15,5),'SIDE CLAMP REFERENCE | opposing front wheels close onto box sides',fill='black',font=font)
  draw.text((15,32),f'Kinematic preview, 2x speed | t={z["time"][k]:.2f}s | 20 x 32 x 10 cm box | dynamics not implied',fill='#666666',font=font)

...
for f in range(0,len(a),3):
 ...
 draw.text((658,5),'Adapted: pick / transport / place',fill='black',font=font)
 draw.text((18,29),f'{f/30:.2f} s | '+('PICK / LIFT' if f<85 else 'BLEND IN' if f<100 else 'TRANSPORT' if f<140 else 'BLEND OUT' if f<155 else 'LOWER / PLACE' if f<215 else 'RELEASE / RETRACT')+' | kinematics only',fill='#666666',font=font)
